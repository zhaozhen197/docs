...
It is very likely that `jetty` does not support the currently selected architecture (`arm32v7`).
...
```console
$ docker run -d arm32v7/jetty --modules=jmx jetty.threadPool.maxThreads=500
```
