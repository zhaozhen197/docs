...
It is very likely that `jetty` does not support the currently selected architecture (`arm32v6`).
...
```console
$ docker run -d arm32v6/jetty --modules=jmx jetty.threadPool.maxThreads=500
```
