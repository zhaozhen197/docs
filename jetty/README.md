...
It is very likely that `jetty` does not support the currently selected architecture (`arm64v8`).
...
```console
$ docker run -d arm64v8/jetty --modules=jmx jetty.threadPool.maxThreads=500
```
