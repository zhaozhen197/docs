...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/jetty/badge/icon) (`amd64/jetty` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/jetty/)
...
```console
$ docker run -d amd64/jetty --modules=jmx jetty.threadPool.maxThreads=500
```
