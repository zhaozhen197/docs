...
It is very likely that `jetty` does not support the currently selected architecture (`arm32v5`).
...
```console
$ docker run -d arm32v5/jetty --modules=jmx jetty.threadPool.maxThreads=500
```
