...
It is very likely that `jetty` does not support the currently selected architecture (`i386`).
...
```console
$ docker run -d i386/jetty --modules=jmx jetty.threadPool.maxThreads=500
```
