...
It is very likely that `sonarqube` does not support the currently selected architecture (`arm32v6`).
...
```console
$ docker run -d --name sonarqube -p 9000:9000 -p 9092:9092 arm32v6/sonarqube
```
