...
It is very likely that `sonarqube` does not support the currently selected architecture (`i386`).
...
```console
$ docker run -d --name sonarqube -p 9000:9000 -p 9092:9092 i386/sonarqube
```
