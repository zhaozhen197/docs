...
It is very likely that `sonarqube` does not support the currently selected architecture (`windows-amd64`).
...
```console
$ docker run -d --name sonarqube -p 9000:9000 -p 9092:9092 winamd64/sonarqube
```
