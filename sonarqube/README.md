...
It is very likely that `sonarqube` does not support the currently selected architecture (`ppc64le`).
...
```console
$ docker run -d --name sonarqube -p 9000:9000 -p 9092:9092 ppc64le/sonarqube
```
