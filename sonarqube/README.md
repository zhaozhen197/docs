...
It is very likely that `sonarqube` does not support the currently selected architecture (`arm64v8`).
...
```console
$ docker run -d --name sonarqube -p 9000:9000 -p 9092:9092 arm64v8/sonarqube
```
