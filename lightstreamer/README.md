...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/lightstreamer/badge/icon) (`amd64/lightstreamer` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/lightstreamer/)
