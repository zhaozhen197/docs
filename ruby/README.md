...
-	[`2.5.0-stretch`, `2.5-stretch`, `2-stretch`, `stretch`, `2.5.0`, `2.5`, `2`, `latest` (*2.5/stretch/Dockerfile*)](https://github.com/docker-library/ruby/blob/e5d5ed23036c66c5797c39e0e156de5d006dbfc0/2.5/stretch/Dockerfile)
-	[`2.5.0-slim-stretch`, `2.5-slim-stretch`, `2-slim-stretch`, `slim-stretch`, `2.5.0-slim`, `2.5-slim`, `2-slim`, `slim` (*2.5/stretch/slim/Dockerfile*)](https://github.com/docker-library/ruby/blob/e5d5ed23036c66c5797c39e0e156de5d006dbfc0/2.5/stretch/slim/Dockerfile)
-	[`2.5.0-alpine3.7`, `2.5-alpine3.7`, `2-alpine3.7`, `alpine3.7`, `2.5.0-alpine`, `2.5-alpine`, `2-alpine`, `alpine` (*2.5/alpine3.7/Dockerfile*)](https://github.com/docker-library/ruby/blob/e5d5ed23036c66c5797c39e0e156de5d006dbfc0/2.5/alpine3.7/Dockerfile)
-	[`2.4.3-stretch`, `2.4-stretch` (*2.4/stretch/Dockerfile*)](https://github.com/docker-library/ruby/blob/1d0fe6a9d5c75d8a114fb03016f528d68c613d80/2.4/stretch/Dockerfile)
-	[`2.4.3-slim-stretch`, `2.4-slim-stretch` (*2.4/stretch/slim/Dockerfile*)](https://github.com/docker-library/ruby/blob/1d0fe6a9d5c75d8a114fb03016f528d68c613d80/2.4/stretch/slim/Dockerfile)
-	[`2.4.3-jessie`, `2.4-jessie`, `2.4.3`, `2.4` (*2.4/jessie/Dockerfile*)](https://github.com/docker-library/ruby/blob/1d0fe6a9d5c75d8a114fb03016f528d68c613d80/2.4/jessie/Dockerfile)
-	[`2.4.3-slim-jessie`, `2.4-slim-jessie`, `2.4.3-slim`, `2.4-slim` (*2.4/jessie/slim/Dockerfile*)](https://github.com/docker-library/ruby/blob/1d0fe6a9d5c75d8a114fb03016f528d68c613d80/2.4/jessie/slim/Dockerfile)
...
```console
$ docker run --rm -v "$PWD":/usr/src/app -w /usr/src/app arm64v8/ruby:2.1 bundle install
```
...
```console
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/myapp -w /usr/src/myapp arm64v8/ruby:2.1 ruby your-daemon-or-script.rb
```
