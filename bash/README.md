...
-	[`4.4.12`, `4.4`, `4`, `latest` (*4.4/Dockerfile*)](https://github.com/tianon/docker-bash/blob/63052402ddc3427912d780eaf9caf71bd03f8b2d/4.4/Dockerfile)
...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/bash/badge/icon) (`arm64v8/bash` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/bash/)
