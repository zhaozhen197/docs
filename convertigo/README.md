...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/convertigo/badge/icon) (`arm32v6/convertigo` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/convertigo/)
...
The `arm32v6/convertigo` images come in many flavors, each designed for a specific use case.

## `arm32v6/convertigo:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `arm32v6/convertigo:alpine`
