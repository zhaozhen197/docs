...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/odoo/badge/icon) (`amd64/odoo` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/odoo/)
