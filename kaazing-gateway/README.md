...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/kaazing-gateway/badge/icon) (`amd64/kaazing-gateway` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/kaazing-gateway/)
