...
-	[`9`, `9.10`, `9.10.1`, `9-mysql-tomcat`, `stable-mysql-tomcat`, `stable-mysql`, `stable` (*9/mysql-tomcat/Dockerfile*)](https://github.com/xwiki-contrib/docker-xwiki/blob/ebb7e79fa3f4da7d8a6cb7c8451a08fee2e1d2a3/9/mysql-tomcat/Dockerfile)
...
-	[`9-postgres-tomcat`, `9.10-postgres-tomcat`, `9.10.1-postgres-tomcat`, `stable-postgres-tomcat`, `stable-postgres` (*9/postgres-tomcat/Dockerfile*)](https://github.com/xwiki-contrib/docker-xwiki/blob/ebb7e79fa3f4da7d8a6cb7c8451a08fee2e1d2a3/9/postgres-tomcat/Dockerfile)
