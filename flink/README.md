...
```console
$ docker run --name flink_local -p 8081:8081 -t ppc64le/flink local
```
...
```console
$ docker run --rm -t ppc64le/flink flink run -m <jobmanager:port> -c <your_class> <your_jar> <your_params>
```
