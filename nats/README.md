...
-	[`1.0.4-linux`, `linux` (*arm64v8/Dockerfile*)](https://github.com/nats-io/nats-docker/blob/4e0129ffe9d12beec981238c6cb54f5faa0fbe57/arm64v8/Dockerfile)

## Shared Tags

-	`1.0.4`, `latest`:
	-	[`1.0.4-linux` (*arm64v8/Dockerfile*)](https://github.com/nats-io/nats-docker/blob/4e0129ffe9d12beec981238c6cb54f5faa0fbe57/arm64v8/Dockerfile)
...
$ docker run -d --name nats-main arm64v8/nats
...
# config file.
$ docker run -d --name=nats-2 --link nats-main arm64v8/nats -c gnatsd.conf --routes=nats-route://ruser:T0pS3cr3t@nats-main:6222

# If you want to verify the routes are connected, try this instead:
$ docker run -d --name=nats-2 --link nats-main arm64v8/nats -c gnatsd.conf --routes=nats-route://ruser:T0pS3cr3t@nats-main:6222 -DV
[INF] Starting nats-server version 1.0.4
