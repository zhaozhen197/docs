...
It is very likely that `mongo-express` does not support the currently selected architecture (`arm32v5`).
...
```console
$ docker run --link some_mongo_container:mongo -p 8081:8081 arm32v5/mongo-express
```
