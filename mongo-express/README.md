...
It is very likely that `mongo-express` does not support the currently selected architecture (`ppc64le`).
...
```console
$ docker run --link some_mongo_container:mongo -p 8081:8081 ppc64le/mongo-express
```
