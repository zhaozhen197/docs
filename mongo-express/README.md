...
It is very likely that `mongo-express` does not support the currently selected architecture (`i386`).
...
```console
$ docker run --link some_mongo_container:mongo -p 8081:8081 i386/mongo-express
```
