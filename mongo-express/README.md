...
It is very likely that `mongo-express` does not support the currently selected architecture (`arm64v8`).
...
```console
$ docker run --link some_mongo_container:mongo -p 8081:8081 arm64v8/mongo-express
```
