...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/swarm/badge/icon) (`amd64/swarm` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/swarm/)
