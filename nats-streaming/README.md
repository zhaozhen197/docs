...
-	[`0.7.0-linux`, `linux` (*arm32v7/Dockerfile*)](https://github.com/nats-io/nats-streaming-docker/blob/212a8f50575d4178722b869025ac7164d2da976f/arm32v7/Dockerfile)

## Shared Tags

-	`0.7.0`, `latest`:
	-	[`0.7.0-linux` (*arm32v7/Dockerfile*)](https://github.com/nats-io/nats-streaming-docker/blob/212a8f50575d4178722b869025ac7164d2da976f/arm32v7/Dockerfile)
...
$ docker run -d arm32v7/nats-streaming
```
...
```bash
$ docker run -d arm32v7/nats-streaming -store file -dir datastore
