...
### `arm32v6/ubuntu:16.04`

```console
$ docker run arm32v6/ubuntu:16.04 grep -v '^#' /etc/apt/sources.list
...
### `arm32v6/ubuntu:14.04`

```console
$ docker run arm32v6/ubuntu:14.04 grep -v '^#' /etc/apt/sources.list
