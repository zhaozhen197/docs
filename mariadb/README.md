...
It is very likely that `mariadb` does not support the currently selected architecture (`i386`).
...
... where `some-mariadb` is the name of your original `i386/mariadb` container.
