...
-	[`linux` (*ppc64le/hello-seattle/Dockerfile*)](https://github.com/docker-library/hello-world/blob/c83a065a24e94e635ddd518c2a3cffc91accf30d/ppc64le/hello-seattle/Dockerfile)
...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/hello-seattle/badge/icon) (`ppc64le/hello-seattle` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/hello-seattle/)
...
```console
$ docker run ppc64le/hello-seattle
