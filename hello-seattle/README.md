...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/hello-seattle/badge/icon) (`arm32v6/hello-seattle` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v6/job/hello-seattle/)
...
```console
$ docker run arm32v6/hello-seattle
