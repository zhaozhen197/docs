...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/plone/badge/icon) (`amd64/plone` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/plone/)
...
```console
$ docker run --name=zeo amd64/plone zeoserver
```

Start 2 Plone clients

```console
$ docker run --link=zeo -e ZEO_ADDRESS=zeo:8100 -p 8081:8080 amd64/plone
$ docker run --link=zeo -e ZEO_ADDRESS=zeo:8100 -p 8082:8080 amd64/plone
```
