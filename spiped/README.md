...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/spiped/badge/icon) (`amd64/spiped` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/spiped/)
