...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/clojure/badge/icon) (`ppc64le/clojure` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/clojure/)
...
The `ppc64le/clojure` images come in many flavors, each designed for a specific use case.

## `ppc64le/clojure:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `ppc64le/clojure:onbuild`
