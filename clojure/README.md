...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/clojure/badge/icon) (`arm32v5/clojure` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/clojure/)
...
The `arm32v5/clojure` images come in many flavors, each designed for a specific use case.

## `arm32v5/clojure:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `arm32v5/clojure:onbuild`
