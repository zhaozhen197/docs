...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/httpd/badge/icon) (`amd64/httpd` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/httpd/)
