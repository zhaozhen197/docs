...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/storm/badge/icon) (`amd64/storm` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/storm/)
